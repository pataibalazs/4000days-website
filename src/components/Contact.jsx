          ...
          <div className="grid grid-cols-1 gap-y-6">
            ...
            <div>
              <button
                ...
                className="block w-full rounded-md bg-[#1a9959] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-[#16874d] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1a9959] disabled:opacity-70 disabled:cursor-not-allowed"
              >
